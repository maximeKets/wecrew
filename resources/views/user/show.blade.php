...
<head>
    ...
    <meta
        content="W3CREW is an awesome utility for building teams. Finding a crew for your project has never been easier! W3CREW connects project owners and freelancers in a trusted user friendly platform. No more DMs. No more time wasted. Phase 1 of W3CREW is calling all freelancers working in web3 to set up their profiles."
        name="description">
    ...
    <meta
        content="https://uploads-ssl.webflow.com/6352b3ee3bc91e36df9c3b4f/6374f05dfd7e607038214714_W3CREW%20webclip.png"
        property="og:image">
        ...
        <div class="div-block-4">
            <div class="div-block-10">
                <div class="html-embed-3 w-embed">
                    <svg width="600" height="auto" viewbox="0 0 825 141" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M43.9549 138.526H67.1671L98.4459 35.4561L130.877 138.526H153.925L196.563 2.80351H173.021L140.755 105.379L108.159 2.80351H88.733L56.9603 105.379L23.706 2.80351H0L43.9549 138.526Z"
                            fill="#EFEEE9"></path>
                        <path
                            d="M279.972 138.526H205.726V116.923H257.419V78.993H210.006V59.0386H257.419V24.2421H205.726V2.80351H279.972V138.526Z"
                            fill="#EFEEE9"></path>
                        <path
                            d="M360.786 141C397.498 141 427.954 112.47 430.917 78.0035H408.034C405.071 100.267 385.645 118.407 360.786 118.407C333.294 118.407 312.881 96.1439 312.881 70.5825C312.881 45.021 333.294 22.593 360.786 22.593C385.151 22.593 404.741 40.5684 408.034 62.5018H430.917C427.46 28.3649 397.333 0 360.786 0C321.112 0 290.327 32.8175 290.327 70.5825C290.327 108.347 321.112 141 360.786 141Z"
                            fill="#EFEEE9"></path>
                        <path
                            d="M535.629 138.526L512.91 97.6281C527.727 88.0632 534.312 71.7368 534.312 54.586C534.312 27.5403 518.672 2.63859 476.034 2.63859H446.073V138.691H468.626V106.533H478.833C483.936 106.533 488.546 106.039 492.826 105.379L508.63 138.526H535.629ZM468.626 84.6V24.7368H479.492C500.564 24.7368 512.252 36.1158 512.252 54.586C512.252 72.3965 500.893 84.6 479.492 84.6H468.626Z"
                            fill="#EFEEE9"></path>
                        <path
                            d="M549.928 138.526H624.174V116.923H572.482V78.993H619.894V59.0386H572.482V24.2421H624.174V2.80351H549.928V138.526Z"
                            fill="#EFEEE9"></path>
                        <path
                            d="M672.392 138.526H695.605L726.883 35.4561L759.315 138.526H782.362L825 2.80351H801.459L769.192 105.379L736.596 2.80351H717.17L685.398 105.379L652.143 2.80351H628.438L672.392 138.526Z"
                            fill="#EFEEE9"></path>
                    </svg>
                </div>
            </div>
            <div class="div-block-6">
                <div class="footer-menu-block">
                    ...
                    <a href="https://cosmic-crew.gitbook.io/cosmic-crew-whitepaper/" target="_blank"
